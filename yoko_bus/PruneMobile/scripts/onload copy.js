...
const socket = new WebSocket('wss://localhost:8080/echo'); // websocketの確立
...
socket.onmessage = function (event) {
    ...
    //// Ebata:console.log("233");
    //// Ebata:console.log("obj.id:", obj.id);
    //// Ebata:console.log("obj.lat:", obj.lat);
    //// Ebata:console.log("obj.lng:", obj.lng);
    //// Ebata:console.log("obj.type:", obj.type);
    //// Ebata:console.log("obj.popup:", obj.popup);
